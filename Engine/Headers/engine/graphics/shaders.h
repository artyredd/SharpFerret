...
struct _shaderMethods {
	...
	/// </summary>
	void (*Disable)(Shader);
	bool (*SetVector2)(Shader, Uniform, vector2 value);
	bool (*SetVector3)(Shader, Uniform, vector3 value);
	bool (*SetVector4)(Shader, Uniform, vector4 value);
	bool (*SetColor)(Shader, Uniform, color value);
